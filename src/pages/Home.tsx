  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-forest-900">
        <img
          src="/images/team.jpg"
          alt="CHOB participants and staff together in the office"
          className="absolute inset-0 -z-10 h-full w-full object-cover object-[center_35%] opacity-40"
        />
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-forest-900 via-forest-900/80 to-forest-900/20" />
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 md:grid-cols-2 lg:gap-20 lg:px-8 lg:py-28">
        <div className="grid grid-cols-2 gap-4">
          <img src="/images/renovation-attic.jpg" alt="A crew member surveying an attic renovation" className="aspect-[3/4] w-full rounded-3xl object-cover" />
          <img src="/images/program-orientation.jpg" alt="Participants at a program orientation" className="mt-12 aspect-[3/4] w-full rounded-3xl object-cover" />
        </div>
        <div>
